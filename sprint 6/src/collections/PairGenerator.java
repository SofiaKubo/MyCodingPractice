...
public class PairGenerator {
    ...
    private List<Stranger> getRandomPair(List<Stranger> strangers) {
       ...
       /* Collection<Stranger> removedStrangers = new ArrayList<>();
        removedStrangers.add(strangerOne);
        removedStrangers.add(strangerTwo);
        strangers.removeAll(removedStrangers);*/
        strangers.remove(Math.max(p1Index, p2Index));
        strangers.remove(Math.min(p1Index, p2Index));
